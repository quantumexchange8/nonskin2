    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="myExtraLargeModalLabel">Add New Member</h5>
                                    ...
                                    <div id="addmember-memberinfo-collapse" class="collapse show" data-bs-parent="#addmember-accordion">
                                        <div class="p-4 border-top">
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        <label class="form-label required" for="code">Member Code</label>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <select class="form-select" name="category_id"
                                                            ...
                                                            <option value="1">Retail members</option>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        <label class="form-label required" for="name-en">Member Name (EN)</label>
                                                        <input id="name-en" name="name_en" placeholder="Enter member Name" type="text" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        <label class="form-label required" for="name-cn">Member Name (CN)</label>
                                                        <input id="name-cn" name="name_cn" placeholder="Enter member Name" type="text" class="form-control">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                    ...
                                    <a href="#addmember-img-collapse" class="text-dark collapsed" data-bs-toggle="collapse" aria-haspopup="true" aria-expanded="false" aria-haspopup="true" aria-controls="addmember-img-collapse">
                                        <div class="p-4">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1 overflow-hidden">
                                                    <h5 class="font-size-16 mb-1">member Image</h5>
                                                    <p class="text-muted text-truncate mb-0">Fill all information below</p>
                                                </div>
                                                <div class="flex-shrink-0">
                                                    <i class="mdi mdi-chevron-up accor-down-icon font-size-24"></i>
