...
@section('title') Quarterly Commission Report @endsection

@section('content')
    @component('components.breadcrumb')
    @slot('url') {{ url('/') }} @endslot
    @slot('li_1') Home @endslot
    @slot('title') Quarterly Commission Report @endslot
    @endcomponent
...
@section('script')
    ...
    <script>
        function exportToCsv() {
            const table = document.querySelector("#reportQuarterly");
            ...
            a.download = "Quarterly Commission Report.csv";
