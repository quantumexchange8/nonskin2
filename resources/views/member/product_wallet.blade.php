                        ...
                        <tbody>
                            @foreach ($product_wallet as $row)
                                <tr>
                                    ...
                                    <td>@if($row->cash_in != null) RM {{ number_format($row->cash_in, 2) }} @else - @endif</td>
                                    <td>@if($row->cash_out != null) RM {{ number_format($row->cash_out, 2) }} @else - @endif </td>
...
@section('script')
    ...
    <script>
        ...
        $(document).ready(function() {
            var table = $('#productWallet').DataTable({
                responsive: true,
                lengthChange: false,
                // order: [[0, 'desc']], 
